...
function Linux.Create(config)
    ...
    if config.IdentifyExecutor then
        ...
        if executorName ~= "Unknown" then
            ExecutorLabel = Linux.Instance("Frame", {
                ...
                Position = UDim2.new(0, TitleLabel.TextBounds.X + 60, 0, 4),
                ZIndex = 2
            })
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Dropdown(config)
            ...
            local DropOutline = Linux.Instance("Frame", {
                Parent = DropFrame,
                BackgroundTransparency = 1,
                Size = UDim2.new(1, 2, 1, 2),
                Position = UDim2.new(0, -1, 0, -1),
            ...
            local function PopulateOptions()
                ...
                if IsOpen then
                    for _, opt in pairs(Options) do
                        ...
                        local OptOutline = Linux.Instance("Frame", {
                            Parent = OptBtn,
                            BackgroundTransparency = 1,
                            Size = UDim2.new(1, 2, 1, 2),
                            Position = UDim2.new(0, -1, 0, -1),
        ...
        function TabElements.Input(config)
            ...
            local TextBoxOutline = Linux.Instance("Frame", {
                Parent = TextBox,
                BackgroundTransparency = 1,
                Size = UDim2.new(1, 2, 1, 2),
                Position = UDim2.new(0, -1, 0, -1),
