...
function Linux:Notify(config)
    ...
    local Gradient = Linux.Instance("UIGradient", {
        ...
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(100, 160, 200)),
...
function Linux.Create(config)
    ...
    if config.IdentifyExecutor then
        ...
        if executorName ~= "Unknown" then
            local offset = config.ShowBetaLabel and 60 or 15
            ExecutorLabel = Linux.Instance("Frame", {
                Parent = TopBar,
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                BackgroundTransparency = 0,
                Size = UDim2.new(0, 80, 0, 16),
                Position = UDim2.new(0, TitleLabel.TextBounds.X + offset, 0, 4),
                ZIndex = 2
            })

            local ExecutorGradient = Linux.Instance("UIGradient", {
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Input(config)
            ...
            local TextBoxGradient = Linux.Instance("UIGradient", {
                Parent = TextBox,
                Color = ColorSequence.new({
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(80, 130, 160)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(200, 120, 160))
                }),
                Rotation = 45
            })
