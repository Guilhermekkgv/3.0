    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Toggle(config)
            ...
            local Gradient = Linux.Instance("UIGradient", {
                ...
                Color = ColorSequence.new({
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(70, 130, 180)),
                    ColorSequenceKeypoint.new(1 Grok Response, Color3.fromRGB(255, 105, 180))
                }),
                Rotation = 45
            })
        ...
        function TabElements.Dropdown(config)
            ...
            local function UpdateDropSize()
                ...
                task.wait(0.2)
                TabContent.CanvasSize = UDim2.new(0, 0, 0, ElementContainer.AbsoluteSize.Y + ElementContainer.AbsoluteSize.Y)
            end
